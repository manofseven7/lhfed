    ...
    def train(self):
        ...
        for i in trange(self.num_rounds+1, desc='Round: ', ncols=120):
            ...
            if i % self.eval_every == 0:
                ...
                tqdm.write('At round {} testing accuracy: {}'.format(i, ts_acc))
                tqdm.write('At round {} training accuracy: {}'.format(i, tr_acc))
                tqdm.write('At round {} validating accuracy: {}'.format(i, valid_acc))
