...
# "./log_vehicle/qffedavg_samp1_run1_q5_20_test.csv",
# "./log_vehicle/hgfed_samp1_run1_q0_20_test.csv",
# "./log_vehicle/hgfed_samp2_run1_q0_20_test.csv"
...
"./log_vehicle/afl_samp1_run1_q0_20_test.csv",
"./log_vehicle/hgfed_samp1_run1_q0_20_test.csv",
"./log_vehicle/hgfed_samp2_run1_q0_20_test.csv"



# "./log_synthetic/qffedavg_samp1_run1_q0_2000_test.csv",
# "./log_synthetic/hgfed_samp1_run1_q0_2000_test.csv",
# "./log_synthetic/hgfed_samp2_run1_q0_2000_test.csv"

# "./log_synthetic/afl_samp1_run1_q0_2000_test.csv",
# "./log_synthetic/hgfed_samp1_run1_q0_2000_test.csv",
# "./log_synthetic/hgfed_samp2_run1_q0_2000_test.csv"

# "./log_synthetic/qffedavg_samp1_run1_q1_2000_test.csv",
# "./log_synthetic/hgfed_samp1_run1_q0_2000_test.csv",
# "./log_synthetic/hgfed_samp2_run1_q0_2000_test.csv"



#"./log_fmnist/qffedavg_samp1_run1_q0_10_test.csv",
# "./log_fmnist/hgfed_samp1_run1_q0_10_test.csv",
# "./log_fmnist/hgfed_samp2_run1_q0_10_test.csv"
]
...
dataset = ["vehicle"]
# dataset = ["synthetic"]
label_ = ["afl", "lhfed, n=2", 'lhfed uniform, n=2']
...
def get_bar_y(filename, num_clients, num_bar=39):
    ...
    for line in open(filename, 'r'):
        ...
        accuracies[int(idx/num_clients)][idx % num_clients] = accu
...
#f.savefig("fairness_fmnist.pdf")
# f.savefig("fairness_vehicle2.pdf")
# f.savefig("fairness_synthetic3__fedavg.pdf")

# f.savefig("fairness_vehicle3__fedavg.pdf")
# f.savefig("fairness_vehicle3__qfedavg.pdf")
f.savefig("fairness_vehicle3__afl.pdf")
